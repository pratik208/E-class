package com.codecrafters.sanika.Chat_Section;
...
public class Chat_Handler extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        database1 = FirebaseDatabase.getInstance("https://test-quiz-a95f2-default-rtdb.firebaseio.com/").getReference();
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://test-quiz-a95f2-default-rtdb.firebaseio.com/");
        ...
        final String user_id = "gs://test-quiz-a95f2.appspot.com" + auth.getUid();
